...
const Login = () => {
  ...
  return (
    <form className='min-h-[80vh]flex item-center justify-center'>
      <div className='flex flex-col gap-5 m-auto item-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
